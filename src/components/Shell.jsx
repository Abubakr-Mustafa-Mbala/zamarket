...
const STAFF_NAV = [
  ...
  { to: '/admin/money-check', label: 'Check the money' },
...
const VENDOR_NAV = [
  ...
  { to: '/vendor/studio', label: 'Creative Studio' },
